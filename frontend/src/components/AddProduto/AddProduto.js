    ...
    <Modal show={showModal} onHide={handleClose}>
      ...
      <Modal.Body className="m-3">
        <form onSubmit={handleSubmit}>
          ...
          <label className="mt-3 mb-1" htmlFor="descricao">Descrição</label>
          <textarea
            id="descricao"
          ...
          <label className="mt-3 mb-1" htmlFor="preco">Preço</label>
          <input
            type="number"
            id="preco"
            className="form-control"
          ...
          <label className="mt-3 mb-1" htmlFor="estoque">Estoque</label>
          <input
            type="number"
            id="estoque"
            className="form-control"
          ...
          <label className="mt-3 mb-1" htmlFor="imagem">Imagem</label>
          <input
            type="file"
            id="imagem"
            className={
